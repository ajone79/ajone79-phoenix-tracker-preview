...
const EVENTS_TAGGED = [
  ...
  // --- Meta chain ---
  {id:'cause_and_effect_part_1_meta_sms', name:'Cause and Effect Part 1 Meta', variant:'SMS', category:'META', heroic:false, opsMin:20, opsMax:80, time:{h:17,m:0},
  ...
  {id:'trelanes_tribulations_meta_sms', name:"Trelane's Tribulations Meta", variant:'SMS', category:'META', heroic:false, opsMin:61, opsMax:80, time:{h:17,m:0},
  ...
  {id:'trelanes_treasures_heroic_sms', name:"Trelane's Treasures (Heroic)", variant:'SMS', category:'MISSION', heroic:true, opsMin:51, opsMax:80, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-20', end:'2026-08-26'}]}, note:'Score by unlocking Epic Cause and Effect Artifacts.'},
  {id:'the_bridge_is_yours_heroic_sms', name:'The Bridge is Yours (Heroic)', variant:'SMS', category:'MISSION', heroic:true, opsMin:51, opsMax:80, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-20', end:'2026-08-26'}]}, note:'Score by unlocking Rare Cause and Effect Artifacts.'},
  {id:'time_fractured_studies_heroic_sms', name:'Time Fractured Studies (Heroic)', variant:'SMS', category:'MISSION', heroic:true, opsMin:61, opsMax:80, time:{h:17,m:0},
  ...
  {id:'cause_and_effect_corruption_sms', name:'Cause and Effect: Corruption', variant:'SMS', category:'HOSTILES', heroic:false, opsMin:20, opsMax:60, time:{h:17,m:0},
    occ:{kind:'dates', dates:['2026-08-23','2026-08-30','2026-09-06','2026-09-13']}, note:'Destroy hostiles or Mirror Universe hostiles.'},
  {id:'cause_and_effect_ruin_sms', name:'Cause and Effect: Ruin', variant:'SMS', category:'HOSTILES', heroic:false, opsMin:20, opsMax:60, time:{h:17,m:0},
  ...
  {id:'cause_and_effect_impersonation_sms', name:'Cause and Effect: Impersonation', variant:'SMS', category:'HOSTILES', heroic:false, opsMin:61, opsMax:80, time:{h:17,m:0},
    occ:{kind:'dates', dates:['2026-08-24','2026-08-31','2026-09-07','2026-09-14']}, note:"Destroy V'ger hostiles."},
  {id:'cause_and_effect_separation_sms', name:'Cause and Effect: Separation', variant:'SMS', category:'HOSTILES', heroic:false, opsMin:20, opsMax:39, time:{h:17,m:0},
    occ:{kind:'dates', dates:['2026-08-26','2026-09-02','2026-09-09','2026-09-16']}, note:'Destroy Swarm hostiles.'},
  {id:'cause_and_effect_predators_sms', name:'Cause and Effect: Predators', variant:'SMS', category:'HOSTILES', heroic:false, opsMin:40, opsMax:50, time:{h:17,m:0},
    occ:{kind:'dates', dates:['2026-08-26','2026-09-02','2026-09-09','2026-09-16']}, note:'Destroy Hirogen and Lost hostiles.'},
  {id:'cause_and_effect_fracture_sms', name:'Cause and Effect: Fracture', variant:'SMS', category:'HOSTILES', heroic:false, opsMin:51, opsMax:80, time:{h:17,m:0},
  ...
  {id:'trelanes_tribulations_inquiry_sms', name:"Trelane's Tribulations: Inquiry", variant:'SMS', category:'HOSTILES', heroic:false, opsMin:61, opsMax:80, time:{h:17,m:0},
  ...
  {id:'trelanes_tribulations_enlightenment_sms', name:"Trelane's Tribulations: Enlightenment", variant:'SMS', category:'HOSTILES', heroic:false, opsMin:61, opsMax:80, time:{h:17,m:0},
  ...
  {id:'trelanes_tribulations_scrutiny_heroic_sms', name:"Trelane's Tribulations: Scrutiny (Heroic)", variant:'SMS', category:'HOSTILES', heroic:true, opsMin:61, opsMax:80, time:{h:17,m:0},
    ...
    note:'Destroy hostiles in systems with a Galactic Anomaly.'},
  {id:'trelanes_tribulations_doubt_sms', name:"Trelane's Tribulations: Doubt", variant:'SMS', category:'HOSTILES', heroic:false, opsMin:61, opsMax:80, time:{h:17,m:0},
  ...
  {id:'trelanes_tribulations_synergy_sms', name:"Trelane's Tribulations: Synergy", variant:'SMS', category:'WAVES', heroic:false, opsMin:61, opsMax:80, time:{h:17,m:0},
    occ:{kind:'dates', dates:['2026-08-23','2026-08-30','2026-09-06','2026-09-13']},
    note:'Complete Duo Wave Defense waves.'},
  {id:'trelanes_tribulations_assault_slb', name:"Trelane's Tribulations: Assault", variant:'SLB', category:'HOSTILES', heroic:false, opsMin:61, opsMax:80, time:{h:17,m:0},
  ...
  {id:'five_of_eleven_recruit_heroic_sms', name:'Five of Eleven Recruit (Heroic)', variant:'SMS', category:'RECRUIT', heroic:true, opsMin:20, opsMax:39, time:{h:17,m:0},
  ...
  {id:'five_of_eleven_recruit_heroic_slb', name:'Five of Eleven Recruit (Heroic)', variant:'SLB', category:'RECRUIT', heroic:true, opsMin:20, opsMax:39, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-22',end:'2026-08-23'},{start:'2026-08-29',end:'2026-08-30'},{start:'2026-09-05',end:'2026-09-06'},{start:'2026-09-12',end:'2026-09-13'}]},
    note:'Leaderboard — spend G3 U+ materials to earn Five of Eleven shards.'},
  {id:'sam_kirk_recruit_heroic_sms', name:'Sam Kirk Recruit (Heroic)', variant:'SMS', category:'RECRUIT', heroic:true, opsMin:40, opsMax:60, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-22',end:'2026-08-23'},{start:'2026-08-29',end:'2026-08-30'},{start:'2026-09-05',end:'2026-09-06'},{start:'2026-09-12',end:'2026-09-13'}]},
    note:'Spend G3 U+ materials to earn epic officer SNW Sam Kirk shards.'},
  {id:'sam_kirk_recruit_heroic_slb', name:'Sam Kirk Recruit (Heroic)', variant:'SLB', category:'RECRUIT', heroic:true, opsMin:40, opsMax:60, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-22',end:'2026-08-23'},{start:'2026-08-29',end:'2026-08-30'},{start:'2026-09-05',end:'2026-09-06'},{start:'2026-09-12',end:'2026-09-13'}]},
    note:'Leaderboard — spend G3 U+ materials to earn SNW Sam Kirk shards.'},
  {id:'trelane_recruit_heroic_sms', name:'Trelane Recruit (Heroic)', variant:'SMS', category:'RECRUIT', heroic:true, opsMin:61, opsMax:80, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-22',end:'2026-08-23'},{start:'2026-08-29',end:'2026-08-30'},{start:'2026-09-05',end:'2026-09-06'},{start:'2026-09-12',end:'2026-09-13'}]},
    note:'Spend G3 U+ materials to earn epic officer Trelane shards.'},
  {id:'trelane_recruit_heroic_slb', name:'Trelane Recruit (Heroic)', variant:'SLB', category:'RECRUIT', heroic:true, opsMin:61, opsMax:80, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-22',end:'2026-08-23'},{start:'2026-08-29',end:'2026-08-30'},{start:'2026-09-05',end:'2026-09-06'},{start:'2026-09-12',end:'2026-09-13'}]},
    note:'Leaderboard — spend G3 U+ materials to earn Trelane shards.'},

  // --- Wave defense ---
  {id:'duo_wave_defense_sms_slb', name:'Duo Wave Defense', variant:'SMS/SLB', category:'WAVES', heroic:true, opsMin:61, opsMax:999, time:{h:17,m:0},
  ...
  // --- Passes ---
  {id:'ferengi_exchange_pass', name:'Ferengi Exchange Pass', variant:'', category:'PASS', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
  ...
  {id:'wave_defense_pass', name:'Wave Defense Pass', variant:'', category:'PASS', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-27', end:'2026-09-16'}]}, note:'Milestones in the Operation Bulwark events.'},
  {id:'syndicate_pass', name:'Syndicate Pass', variant:'', category:'PASS', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
    occ:{kind:'ranges', ranges:[{start:'2026-08-31', end:'2026-09-06'}]}, note:'Milestones in the Syndicate Pass SMS Events.'},
  {id:'outpost_pass', name:'Outpost Pass', variant:'', category:'PASS', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
  ...
  {id:'nujord_territory_capture', name:'Nujord — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:15,m:0},
    occ:{kind:'weekly', dayOfWeek:5, start:'2026-07-20', end:'2027-12-31'}, note:'PHX conquest window · 1*'},
  {id:'duportas_territory_capture', name:'Duportas — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:14,m:0},
    occ:{kind:'weekly', dayOfWeek:6, start:'2026-07-20', end:'2027-12-31'}, note:'PHX conquest window · 2*'},
  {id:'brellan_territory_capture', name:'Brellan — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:19,m:0},
    occ:{kind:'weekly', dayOfWeek:0, start:'2026-07-20', end:'2027-12-31'}, note:'PHX conquest window · 3*'},
  {id:'bimasa_territory_capture', name:'Bimasa — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
    occ:{kind:'weekly', dayOfWeek:2, start:'2026-07-20', end:'2027-12-31'}, note:'PHX conquest window · 2*'},
  {id:'qoda_territory_capture', name:'Qoda — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:20,m:0},
  ...
  {id:'voyage_across_the_void_into_the_unknown', name:'Voyage Across the Void', variant:'Into the Unknown', category:'VATV', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
  ...
  {id:'voyage_across_the_void_perimeter_breach', name:'Voyage Across the Void', variant:'Perimeter Breach', category:'VATV', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
  ...
  {id:'voyage_across_the_void_singular_strike', name:'Voyage Across the Void', variant:'Singular Strike', category:'VATV', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
  ...
  {id:'voyage_across_the_void_united_offensive', name:'Voyage Across the Void', variant:'United Offensive', category:'VATV', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
  ...
  {id:'voyage_across_the_void_command_mobilization', name:'Voyage Across the Void', variant:'Command Mobilization', category:'VATV', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
  ...
  {id:'voyage_across_the_void_subspace_surge', name:'Voyage Across the Void', variant:'Subspace Surge', category:'VATV', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
  ...
  {id:'voyage_across_the_void_echoes_of_war', name:'Voyage Across the Void', variant:'Echoes of War', category:'VATV', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
